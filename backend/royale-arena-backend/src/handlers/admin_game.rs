...
use crate::models::admin_game::{
    CreateGameRequest, CreateGameResponse, UpdateGameRequest, UpdateGameResponse, DeleteGameResponse,
    CreateRuleTemplateRequest, CreateRuleTemplateResponse, UpdateRuleTemplateRequest, UpdateRuleTemplateResponse, DeleteRuleTemplateResponse
};
...
pub async fn create_game(
    create_request: web::Json<CreateGameRequest>,
) -> Result<HttpResponse> {
    match get_db_connection_from_pool() {
        Ok(mut conn) => {
            match admin_game_service::create_game(&mut conn, &create_request) {
                Ok(game_id) => {
                ...
                Err(e) => {
                    ...
                    Ok(HttpResponse::InternalServerError().json(CreateGameResponse {
                        success: false,
                        game_id: None,
    ...
    match get_db_connection_from_pool() {
        Ok(mut conn) => {
            match admin_game_service::update_game(&mut conn, &game_id, &update_request) {
                Ok(()) => {
                    Ok(HttpResponse::Ok().json(UpdateGameResponse {
                        success: true,
                ...
                Err(e) => {
                    ...
                    Ok(HttpResponse::InternalServerError().json(UpdateGameResponse {
                        success: false,
...
pub async fn delete_game(
    ...
    match get_db_connection_from_pool() {
        Ok(mut conn) => {
            match admin_game_service::delete_game(&mut conn, &game_id) {
                Ok(()) => {
                ...
                Err(e) => {
                    ...
                    Ok(HttpResponse::InternalServerError().json(DeleteGameResponse {
                        success: false,
    ...
    match get_db_connection_from_pool() {
        Ok(mut conn) => {
            match admin_game_service::create_rule_template(&mut conn, &create_request) {
                Ok(template_id) => {
                    Ok(HttpResponse::Ok().json(CreateRuleTemplateResponse {
                        success: true,
                ...
                Err(e) => {
                    ...
                    Ok(HttpResponse::InternalServerError().json(CreateRuleTemplateResponse {
                        success: false,
                        template_id: None,
    ...
    match get_db_connection_from_pool() {
        Ok(mut conn) => {
            match admin_game_service::update_rule_template(&mut conn, &template_id, &update_request) {
                Ok(()) => {
                    Ok(HttpResponse::Ok().json(UpdateRuleTemplateResponse {
                        success: true,
                ...
                Err(e) => {
                    ...
                    Ok(HttpResponse::InternalServerError().json(UpdateRuleTemplateResponse {
                        success: false,
...
pub async fn delete_rule_template(
    ...
    match get_db_connection_from_pool() {
        Ok(mut conn) => {
            match admin_game_service::delete_rule_template(&mut conn, &template_id) {
                Ok(()) => {
                    Ok(HttpResponse::Ok().json(DeleteRuleTemplateResponse {
                        success: true,
                ...
                Err(e) => {
                    ...
                    Ok(HttpResponse::InternalServerError().json(DeleteRuleTemplateResponse {
                        success: false,
