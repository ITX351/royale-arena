...
pub async fn list_admins(
    ...
    let users = admin_service.list_admins().await?;
...
pub async fn create_admin(
    ...
    let user = admin_service.create_admin(request).await?;
...
pub async fn update_admin(
    ...
    let user = admin_service.update_admin(&user_id, request).await?;
...
pub async fn delete_admin(
    ...
    admin_service.delete_admin(&user_id).await?;
