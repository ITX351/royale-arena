    ...
    pub fn dispatch(
        ...
        match action_type {
            ...
            "move_player" => {
                let player_id = action_params.player_id
                    .ok_or_else(|| "Missing player_id parameter".to_string())?;
                let target_place = action_params.target_place
            ...
            "broadcast" => {
                let message = action_params.message
