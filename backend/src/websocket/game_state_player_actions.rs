        ...
        match item.item_type {
            ItemType::Weapon => {
                ...
                let (player_name, equipped_weapon, inventory) = {
                    ...
                    (player.name.clone(), player.equipped_weapon.clone(), player.inventory.clone())
                };
            ...
            ItemType::Equipment => {
                ...
                let (player_name, equipped_armor, inventory) = {
                    ...
                    (player.name.clone(), player.equipped_armor.clone(), player.inventory.clone())
                };
        ...
        match effect_type {
            Some("heal") => {
                ...
                let (life, bleed_damage, bleed_rounds_remaining, inventory) = {
                    ...
                    (player.life, player.bleed_damage, player.bleed_rounds_remaining, player.inventory.clone())
                };
